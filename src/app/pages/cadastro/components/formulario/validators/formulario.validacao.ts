...
export function verificarSeEmailExiste(cliente: Cliente, service: ClienteService):
AsyncValidatorFn {
...
export function verificarSeCpfExiste(cliente: Cliente, service: ClienteService): AsyncValidatorFn {
  return async (control: AbstractControl) => {
